  ...
  <div class="restaurant-item">
    <div class="restaurant-item__header">
      ...
      <div class="restaurant-item__header__rating">
        <p>Rating ⭐️<span class="restaurant-item__header__rating__score">${restaurants.rating}</span></p>
      </div>
    </div>
    <div class="restaurant-item__content">
      <h3 class="restaurant-item-content__name"><a href="/#/detail/${restaurants.id}" id="judulKonten">${
  restaurants.name}</a></h3>
